...
def create_kr210_solver():
    ...
    print ("Total run time to build DH param table and Ts is %04.4f seconds" % (
        time() - constants_build_time))
    ...
    print ("Total run time to multiply is %04.4f seconds" % (
        time() - multiply_time))
...
def test_code(test_case):
    ...
    your_wc = WC_0  # <--- Load your calculated WC values in this array
